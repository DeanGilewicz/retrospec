	...
	<div class="container_post">
		...
		<footer class="entry-footer">
			<?php 
				...
				$socialLinks  = '';
				$socialLinks .= '<div class="container_retrospec_social">';
				$socialLinks .= '<h4>share on</h4> <a class="retrospec_link retrospec_twitter" href="'. $twitterURL .'" target="_blank">Twitter</a>';
				$socialLinks .= '<a class="retrospec_link retrospec_facebook" href="'.$facebookURL.'" target="_blank">Facebook</a>';
				$socialLinks .= '<a class="retrospec_link retrospec_linkedin" href="'.$linkedInURL.'" target="_blank">LinkedIn</a>';
				$socialLinks .= '</div>';
